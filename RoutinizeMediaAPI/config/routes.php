...
$routes->scope('/', function (RouteBuilder $builder) {
    ...
    $builder->connect('photo/save-cover', ['controller' => 'Photo', 'action' => 'saveCover']);
    $builder->connect('photo/replace-cover', ['controller' => 'Photo', 'action' => 'replaceCover']);
    $builder->connect('photo/remove-cover', ['controller' => 'Photo', 'action' => 'removeCover']);
